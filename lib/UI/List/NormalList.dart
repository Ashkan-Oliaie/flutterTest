  ...
  Widget build(BuildContext context) {
    ...
    reducer(state, action) {
      ...
      if (action is Refresh) {
        // print(action.data);
        return localState(data:[],loading:true,localRerender:!state.localRerender,refreshing:true);
      }

      if (action is NextPage) {
        return localState(page:state.page+1,refreshing:true,localRerender:!state.localRerender,);
      }
